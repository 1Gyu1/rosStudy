...
(cl:defmethod cl:initialize-instance :after ((m <TimerFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_code-msg:<TimerFeedback> is deprecated: use my_code-msg:TimerFeedback instead.")))

(cl:ensure-generic-function 'time_elapsed-val :lambda-list '(m))
(cl:defmethod time_elapsed-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_code-msg:time_elapsed-val is deprecated.  Use my_code-msg:time_elapsed instead.")
  (time_elapsed m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_code-msg:time_remaining-val is deprecated.  Use my_code-msg:time_remaining instead.")
  (time_remaining m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Part 3 : Send 'feedback' from server while it is executed~%~%duration time_elapsed~%duration time_remaining~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerFeedback)))
  "Returns full string definition for message of type 'TimerFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Part 3 : Send 'feedback' from server while it is executed~%~%duration time_elapsed~%duration time_remaining~%~%~%~%"))

...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_code-srv:<WordCount-request> is deprecated: use my_code-srv:WordCount-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <WordCount-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_code-srv:words-val is deprecated.  Use my_code-srv:words instead.")
  (words m))
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_code-srv:<WordCount-response> is deprecated: use my_code-srv:WordCount-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <WordCount-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_code-srv:count-val is deprecated.  Use my_code-srv:count instead.")
  (count m))

...
(cl:defmethod cl:initialize-instance :after ((m <rb_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rb_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rb_test_ui-msg:<rb_command> is deprecated: use rb_test_ui-msg:rb_command instead.")))
...
(cl:defmethod cmd-val ((m <rb_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rb_test_ui-msg:cmd-val is deprecated.  Use rb_test_ui-msg:cmd instead.")
  (cmd m))

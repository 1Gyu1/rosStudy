// Generated by gencpp from file rb_connector/rb_data.msg
// DO NOT EDIT!


#ifndef RB_CONNECTOR_MESSAGE_RB_DATA_H
#define RB_CONNECTOR_MESSAGE_RB_DATA_H
...
struct rb_data_
{
  ...
  typedef boost::shared_ptr< ::rb_connector::rb_data_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rb_connector::rb_data_<ContainerAllocator> const> ConstPtr;

}; // struct rb_data_

typedef ::rb_connector::rb_data_<std::allocator<void> > rb_data;

typedef boost::shared_ptr< ::rb_connector::rb_data > rb_dataPtr;
typedef boost::shared_ptr< ::rb_connector::rb_data const> rb_dataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rb_connector::rb_data_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rb_connector::rb_data_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::rb_connector::rb_data_<ContainerAllocator1> & lhs, const ::rb_connector::rb_data_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::rb_connector::rb_data_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rb_connector::rb_data_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rb_connector::rb_data_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rb_connector::rb_data_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rb_connector::rb_data_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rb_connector::rb_data_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rb_connector::rb_data_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rb_connector::rb_data_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0f69b41542cc5084ULL;
  static const uint64_t static_value2 = 0x5b44f32e80be648cULL;
};

template<class ContainerAllocator>
struct DataType< ::rb_connector::rb_data_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rb_connector::rb_data_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# RB Data\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rb_connector::rb_data_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rb_connector::rb_data_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rb_connector::rb_data_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RB_CONNECTOR_MESSAGE_RB_DATA_H
